...
function show_help() {
  ...
  \t-c --container_name\t Name of the container (default robot_humble_container).
...
if [ -f /etc/nv_tegra_release ]; then
    ...
    -v /usr/lib/python3.10/dist-packages:/usr/host_dist_packages:ro \
    -v /usr/lib/aarch64-linux-gnu:/usr/host_libs:ro \
