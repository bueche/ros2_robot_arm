...
- [Dynamixel PID controller tuning](./dynamixel_pid_controller_tuning.md): (*to be done*) There was actually multilple levels of PID-related control. Indeed each Dynamixel servo has a PID controller. We did need to make some adjustments to that configuration for this application. [Learn more...](./dynamixel_pid_controller_tuning.md)
- [Balancing PID controller documentation](./ball_balance_pid_documentation.md): The above described ball detection fed into our overall PID controller whose purpose is to balance the ball bearing in the cup. This section explains how this overall PID controller works. How do you adjust a servo based on knowing the ball coordinates in the image frame? [Learn more..](./ball_balance_pid_documentation.md)
